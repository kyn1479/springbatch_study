...
import com.kyn.springbatch_study.hello_world.g_hello_world_item_reader.reader.MyRead;
 ...
 *   ItemReader的使用：
 *   创建：MyRead
 *  测试类 com.kyn.springbatch_study.hello_world.g_hello_world_item_reader.Test.test1()
 * @date 2021/2/24
 */
@Configuration
public class HelloWorldItemReaderJobConfigurationDemo1 {
    /** 创建Job工厂对象*/
    @Autowired
