package com.kyn.springbatch_study.b_hello_world_flow;
...
public class Test1 {
    ...
    @Resource
    private HelloWorldJobConfigurationDemo4 helloWorldJobConfigurationDemo4;
    /**
     * 任务起动器
     */
    @Autowired
    ...
    @Test
    public void test1(){
        Job job = (Job)helloWorldJobConfigurationDemo4.buildHelloWorldFlowJob4();
        try {
            /* 运行Job */
