...
public class Test1 {
    ...
    @Resource
    private HelloWorldSplitJobConfigurationDemo1 helloWorldSplitJobConfigurationDemo1;
    /**
     * 任务起动器
     */
    @Autowired
    ...
    @Test
    public void test1(){
        Job job = (Job) helloWorldSplitJobConfigurationDemo1.buildHelloWorldSplitJob5();
        try {
            /* 运行Job */
