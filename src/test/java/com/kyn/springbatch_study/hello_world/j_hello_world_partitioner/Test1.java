package com.kyn.springbatch_study.hello_world.j_hello_world_partitioner;
...
public class Test1 {
    ...
    @Resource
    private BatchPartitionerConfiguration batchPartitionerConfiguration;
    ...
    @Test
    public void test1(){
        Job job = (Job) batchPartitionerConfiguration.getBatchDataSplitAndSendJob();
        try {
            /* 运行Job */
