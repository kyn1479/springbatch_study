...
public class Test1 {
    ...
    @Resource
    private HelloWorldDeciderJobConfigurationDemo1 helloWorldDeciderJobConfigurationDemo1;
    /**
     * 任务起动器
     */
    @Autowired
    ...
    @Test
    public void test1(){
        Job job = (Job) helloWorldDeciderJobConfigurationDemo1.buildHelloWorldDeciderJob6();
        try {
            /* 运行Job */
