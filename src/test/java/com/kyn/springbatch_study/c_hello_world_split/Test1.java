package com.kyn.springbatch_study.c_hello_world_split;
...
public class Test1 {
    ...
    @Resource
    private HelloWorldJobConfigurationDemo5 helloWorldJobConfigurationDemo5;
    /**
     * 任务起动器
     */
    @Autowired
    ...
    @Test
    public void test1(){
        Job job = (Job)helloWorldJobConfigurationDemo5.buildHelloWorldSplitJob5();
        try {
            /* 运行Job */
